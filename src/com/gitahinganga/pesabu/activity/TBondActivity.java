...
public class TBondActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tbond);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tbond, menu);
		return true;
	}
	...
	public void calculateTBond(View view) {
		List<View> requiredInputViewList = new ArrayList<View>();
		requiredInputViewList.add(findViewById(R.id.tbondDaysSpinner));
		requiredInputViewList.add(findViewById(R.id.tbondInterestEditText));
		requiredInputViewList.add(findViewById(R.id.tbondFaceValueEditText));
		...
		int days = Integer
				.parseInt(((Spinner) findViewById(R.id.tbondDaysSpinner))
						.getSelectedItem().toString());
		double interestRate = Double
				.parseDouble(((EditText) findViewById(R.id.tbondInterestEditText))
						.getText().toString());
		double faceValue = Double
				.parseDouble(((EditText) findViewById(R.id.tbondFaceValueEditText))
						.getText().toString());
		boolean taxExempt = ((CheckBox) findViewById(R.id.tbondTaxExemptCheckBox))
				.isChecked();
		...
		EditText dvet = (EditText) findViewById(R.id.tbondDiscountedValueEditText);
		dvet.setText(Util.comify(String.valueOf(decimalFormat
				.format(discountedValue))));
		EditText uet = (EditText) findViewById(R.id.tbondUnitsEditText);
		uet.setText(Util.comify(String.valueOf(decimalFormat.format(units))));
		EditText iet = (EditText) findViewById(R.id.tbondInvestmentEditText);
		iet.setText(Util.comify(String.valueOf(decimalFormat.format(investment))));
		EditText ptet = (EditText) findViewById(R.id.tbondDiscountedTotalValueEditText);
		ptet.setText(Util.comify(String.valueOf(decimalFormat
				.format(discountedTotalValue))));
		EditText tet = (EditText) findViewById(R.id.tbondTaxEditText);
		tet.setText(Util.comify(String.valueOf(decimalFormat.format(tax))));
		EditText atpet = (EditText) findViewById(R.id.tbondTotalReturnsEditText);
